...
void Canvas::setPixel(size_t x, size_t y, uint8_t color_index, const std::string& user_id) {
...
bool Canvas::isValidCoord(size_t x, size_t y) const {
...
size_t Canvas::index(size_t x, size_t y) const {
    return y * width_ + x;
}
